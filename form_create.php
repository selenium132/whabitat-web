        ...
        <header class="header">
            <div class="header-inner">
                ...
                <div class="action-bar">
                    <?php if ($edit_mode): ?>
                         <a href="form_delete.php?id=<?php echo $event_data['id']; ?>" class="icon-btn" style="color: #d93025; text-decoration: none; margin-right: 15px;" onclick="return confirm('本当に削除しますか？\nこの操作は取り消せません。');" title="イベントを削除">
