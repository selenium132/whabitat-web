        ...
        <header class="header">
            <div class="header-inner">
                ...
                <div class="action-bar">
                    <?php if ($edit_mode): ?>
                         <form method="POST" action="form_delete.php" style="display: inline;" onsubmit="return confirm('本当に削除しますか？\nこの操作は取り消せません。');">
                            <input type="hidden" name="csrf_token" value="<?php echo generateCsrfToken(); ?>">
                            <input type="hidden" name="id" value="<?php echo $event_data['id']; ?>">
                            <button type="submit" class="icon-btn" style="color: #d93025; border: none; background: none; cursor: pointer;" title="イベントを削除">
